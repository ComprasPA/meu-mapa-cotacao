...
# Estilização visual corporativa estilo Dados Bancários e remoção total da borda da caixa retrátil
st.markdown("""
    <style>
    ...
    /* Remove totalmente a caixa/borda cinza do st.expander para alinhar perfeitamente */
...
# Caixa Oculta (Abre / Fecha) posicionada acima do título do app com altura idêntica à referência
